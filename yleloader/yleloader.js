...
game.Loader.inject({
    ...
    initStage: function() {
        ...
        this.logo = new game.Sprite(game.Texture.fromImage(imageData), game.system.width / 2, game.system.height / 2, {
            anchor: {x: 0.5, y: 0.5}
        });
        ...
        this.symbol = new game.Sprite(game.Texture.fromImage(imageData), game.system.width / 2, game.system.height / 2 + 100, {
            anchor: {x: 0.5, y: 0.5}
        });
