...
game.Ukkio = game.Class.extend({
    init: function() {
        if(!game.Ukkio.apiKey) throw('Ukkio apiKey not defined.');

        game.ukkio = new UkkioSDK({
            apiKey: game.Ukkio.apiKey
        });
    }
});
